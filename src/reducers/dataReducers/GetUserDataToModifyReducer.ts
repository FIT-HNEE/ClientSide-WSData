...
const GetUserDataToModifyReducer = (state: DefaultStateI = defaultState, action: UserDataModifyDispatchTypes) : DefaultStateI   => {
    switch (action.type) {
...
export default GetUserDataToModifyReducer;